-- Limpar dados duplicados e resetar o banco

-- Remover todos os dados das tabelas (exceto o usuário admin)
DELETE FROM leads;
DELETE FROM clients;
DELETE FROM users WHERE email != 'admin@exudustech.com.br';

-- Resetar os sequences para começar do ID 1
ALTER SEQUENCE leads_id_seq RESTART WITH 1;
ALTER SEQUENCE clients_id_seq RESTART WITH 1;
ALTER SEQUENCE users_id_seq RESTART WITH 2; -- Começar do 2 porque o admin já existe

-- Inserir dados limpos sem duplicatas
